package com.dominium.backend.presentation.documento;

import com.dominium.backend.application.documento.dto.DocumentoResponse;
import com.dominium.backend.application.documento.dto.VersaoDocumentoResponse;
import com.dominium.backend.application.documento.usecase.*;
import com.dominium.backend.domain.documento.CategoriaDocumento;
    ...
    public ResponseEntity<?> historico(@PathVariable String id) {
        return exceptionHandler.withHandler(() -> {
            List<VersaoDocumentoResponse> historico = versaoRepository
                    .findByDocumentoId(DocumentoId.de(id))
                    .stream()
