Feature: Gestão de Documentos
  ...
  Scenario: Síndico cadastra um novo documento com sucesso
  ...
  Scenario: Morador tenta cadastrar um documento
  ...
  Scenario: Atualização de documento gera nova versão
  ...
  Scenario: Listagem de documentos ativos para morador
  ...
  Scenario: Inativação de documento pelo síndico
  ...
  Scenario: Consulta de documentos inativos no histórico
  ...
  Scenario: Notificação de documento próximo ao vencimento
