...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        long robertoId = insertUsuario("Roberto Alves", "roberto.alves@parqueverde.com", "123456", "(11) 97777-1001",
        ...
        long jorgeId = insertUsuario("Jorge Santos", "jorge.santos@parqueverde.com", "123456", "(11) 97777-1008",
                "222.222.222-08", "MORADOR");
        long carlaId = insertUsuario("Carla Mendes", "carla.mendes@parqueverde.com", "123456", "(11) 97777-1215",
                "222.222.222-15", "MORADOR");
        long fernandaId = insertUsuario("Fernanda Costa", "fernanda.costa@parqueverde.com", "123456", "(11) 97777-1304",
                "222.222.222-04", "MORADOR");
        long pauloId = insertUsuario("Paulo Oliveira", "paulo.oliveira@parqueverde.com", "123456", "(11) 97777-1312",
        ...
        for (int num = 103; num <= 120; num++) {
            if (num == 108)
                continue;
            long dummyUserId = insertUsuario("Morador Apto " + num, "morador" + num + "@parqueverde.com", "123456",
            ...
            if (num <= 118) {
                insertTaxa(dummyUnitId, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"),
        ...
        insertTaxa(unit102, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15",
                "2026-03-14", "PAGO");
        insertTaxa(unit108, new BigDecimal("580.00"), new BigDecimal("46.00"), new BigDecimal("626.00"), "2026-02-15",
                null, "ATRASADA");
        insertTaxa(unit215, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", null,
                "PENDENTE");
        insertTaxa(unit304, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15",
                "2026-03-13", "PAGO");
        insertTaxa(unit312, new BigDecimal("580.00"), new BigDecimal("92.00"), new BigDecimal("672.00"), "2026-01-15",
                null, "ATRASADA");
        insertTaxa(unit421, new BigDecimal("580.00"), new BigDecimal("17.00"), new BigDecimal("597.00"), "2026-02-15",
                null, "ATRASADA");
        ...
        insertDespesa("Pintura Externa e Restauro Fachada", new BigDecimal("15000.00"), "2026-03-05", "MANUTENCAO",
