...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 1. Seed Sindico
        long sindicoId = insertUsuario("Marco Ribeiro", "marco.ribeiro@dominium.com", "123456", "(11) 98888-8888", "111.111.111-11", "SINDICO");

        // 2. Specific Prototype Resident Users
        long robertoId = insertUsuario("Roberto Alves", "roberto.alves@parqueverde.com", "123456", "(11) 97777-1001", "222.222.222-01", "MORADOR");
        long anaId = insertUsuario("Ana Lima", "ana.lima@parqueverde.com", "123456", "(11) 97777-1002", "222.222.222-02", "MORADOR");
        long jorgeId = insertUsuario("Jorge Santos", "jorge.santos@parqueverde.com", "123456", "(11) 97777-1008", "222.222.222-08", "MORADOR");
        long carlaId = insertUsuario("Carla Mendes", "carla.mendes@parqueverde.com", "123456", "(11) 97777-1215", "222.222.222-15", "MORADOR");
        long fernandaId = insertUsuario("Fernanda Costa", "fernanda.costa@parqueverde.com", "123456", "(11) 97777-1304", "222.222.222-04", "MORADOR");
        long pauloId = insertUsuario("Paulo Oliveira", "paulo.oliveira@parqueverde.com", "123456", "(11) 97777-1312", "222.222.222-12", "MORADOR");
        long rafaelId = insertUsuario("Rafael Lima", "rafael.lima@parqueverde.com", "123456", "(11) 97777-1421", "222.222.222-21", "MORADOR");
        ...
        for (int num = 103; num <= 120; num++) {
            if (num == 108) continue;
            long dummyUserId = insertUsuario("Morador Apto " + num, "morador" + num + "@parqueverde.com", "123456", null, "333.333.333-" + String.format("%02d", num % 100), "MORADOR");
            long dummyUnitId = insertUnidade(String.valueOf(num), "A", dummyUserId, "ADIMPLENTE", BigDecimal.ZERO);
            ...
            if (num <= 118) { // around 80 paid units in Block A
                insertTaxa(dummyUnitId, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", "2026-03-14", "PAGO");
            } else {
                insertTaxa(dummyUnitId, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", null, "PENDENTE");
            }
        }

        // 6. Seed Specific Prototype Condominium Fees (Taxas)
        insertTaxa(unit101, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", "2026-03-14", "PAGO");
        insertTaxa(unit102, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", "2026-03-14", "PAGO");
        insertTaxa(unit108, new BigDecimal("580.00"), new BigDecimal("46.00"), new BigDecimal("626.00"), "2026-02-15", null, "ATRASADA");
        insertTaxa(unit215, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", null, "PENDENTE");
        insertTaxa(unit304, new BigDecimal("580.00"), BigDecimal.ZERO, new BigDecimal("580.00"), "2026-03-15", "2026-03-13", "PAGO");
        insertTaxa(unit312, new BigDecimal("580.00"), new BigDecimal("92.00"), new BigDecimal("672.00"), "2026-01-15", null, "ATRASADA");
        insertTaxa(unit421, new BigDecimal("580.00"), new BigDecimal("17.00"), new BigDecimal("597.00"), "2026-02-15", null, "ATRASADA");

        // 7. Seed 2026 Budget (Orçamento)
        // valorTotal = 120000, valorGasto will be calculated by the DB or manually set to 31450 initially
        ...
        insertDespesa("Serviço de Portaria Especializada", new BigDecimal("18500.00"), "2026-03-01", "PESSOAL", "ORDINARIA", "APROVADA", budget2026);
        insertDespesa("Limpeza Técnica e Conservação", new BigDecimal("8450.00"), "2026-03-02", "UTILIDADES", "ORDINARIA", "APROVADA", budget2026);
        insertDespesa("Manutenção de Elevadores Otis", new BigDecimal("4500.00"), "2026-03-01", "MANUTENCAO", "ORDINARIA", "APROVADA", budget2026);
        
        // 9. Seed pending extraordinary expense for testing approval workflow
        insertDespesa("Pintura Externa e Restauro Fachada", new BigDecimal("15000.00"), "2026-03-05", "MANUTENCAO", "EXTRAORDINARIA", "PENDENTE", budget2026);
    ...
    private long insertUnidade(String numero, String bloco, long proprietarioId, String status, BigDecimal saldoDevedor) {
    ...
    private void insertTaxa(long unidadeId, BigDecimal base, BigDecimal multas, BigDecimal total, String due, String paid, String status) {
    ...
    private void insertDespesa(String descricao, BigDecimal valor, String data, String categoria, String tipo, String status, long orcamentoId) {
